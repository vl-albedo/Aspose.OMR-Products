---
title: Perl Cloud SDK to Read & Process OMR Sheets via REST API 
weight: 70
url: /perl
---
...
{{< blocks/products/pf/sub-menu logoImageSrc="https://products.aspose.cloud/templates/asposecloud/App_Themes/V3/images/sdk/272x272/aspose_omr-for-perl.png" PricingLink="https://purchase.aspose.cloud/pricing" buyLink="https://dashboard.aspose.cloud" docsLink="https://docs.aspose.cloud/omr" directDownloadLink="https://github.com/aspose-omr-cloud/aspose-omr-cloud-perl" liveDemosLink="https://products.aspose.app/omr/family" >}}
...
<p>Aspose.OMR Cloud SDK for Perl works with OMR sheets of various formats, such as BMP, JPEG, TIFF, PNG & PDF. You also have the liberty to define your own OMR templates by the use of several different types of elements. These elements include, text, choice boxes, answer-sheet, logos, images, barcodes, Aruco codes, and QR-codes. Aspose.OMR Cloud SDK for Perl also enhances your cloud Perl code to select a specific area of the OMR sheet, clip it and perform OMR operations only on that specific area of interest.</p>
<p>Using Aspose.OMR Cloud SDK for Perl, you can define rules for grading answers provided via OMR sheets. Based on these rules each answer will be graded and the accumulative OMR result is generated which then can be exported to the CSV format.</p>
{{< /blocks/products/pf/tab-content >}}
   ...
   <div class="row">
    <div class="container">
     <div class="col-lg-12">
      ...
      <p>
       It is easy to get started with Aspose.OMR Cloud SDK for Perl and there is nothing to install. Simply create an account at
       <a href="https://dashboard.aspose.cloud/#/apps">
        Aspose for Cloud
       </a>
       and get your application information. Once you have the App SID &amp; KEY, you are ready to give the Aspose.OMR Cloud SDK for Perl a try on any supported platforms.
      </p>
     </div>
     <div class="col-lg-12">
      <h2 class="h2title">
     ...
     <div class="col-lg-12">
      ...
      <p>
       Along with, Aspose.OMR Cloud SDK for Perl, you can also download an MSI package that installs a light-weight
