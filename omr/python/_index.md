---
title: Build Cloud OMR Sheet Checker & Exporter via Python REST SDK 
description: REST API to build OMR processing apps in Python to detect OMR sheet data, perform answer grading & extract OMR results in the cloud
weight: 90
url: /python
---
...
{{< blocks/products/pf/sub-menu logoImageSrc="https://products.aspose.cloud/templates/asposecloud/App_Themes/V3/images/sdk/272x272/aspose_omr-for-python.png" liveDemosLink="" PricingLink="https://purchase.aspose.cloud/pricing" buyLink="https://dashboard.aspose.cloud" docsLink="https://docs.aspose.cloud/display/omrcloud/Release+Notes" instalationsDocsLink="" nugetLink="" nugetPackageName="" >}}
...
<p>Aspose.OMR Cloud SDK for Python enhances your Python code to apply the OMR operations to a specific area of the scanned image. Currently, the support is available to perform OMR on PDF, TIFF, BMP, PNG & JPEG format files.</p>
<p>Aspose.OMR Cloud SDK for Python is available under an MIT license and works on top of Aspose.OMR REST API. You do not need to install any third-party software to perform OMR actions within your Python cloud apps.</p>
{{< /blocks/products/pf/tab-content >}}
   ...
   <div class="row">
    <div class="container">
     <div class="col-lg-12">
      ...
      <p>
       It is easy to get started with Aspose.OMR Cloud SDK for Python and there is nothing to install. Simply create an account at
       <a href="https://dashboard.aspose.cloud/#/apps">
        Aspose for Cloud
       </a>
       and get your application information. Once you have the App SID &amp; KEY, you are ready to give the Aspose.OMR Cloud SDK for Python a try on any supported platforms.
      </p>
     </div>
     <div class="col-lg-12">
      <h2 class="h2title">
     ...
     <div class="col-lg-12">
      ...
      <p>
       Along with, Aspose.OMR Cloud SDK for Python, you can also download an MSI package that installs a light-weight
